...
def read_dataset(filename):
    ...
    labels=['age', 'have_work', 'have_own_house', 'credit_position'] 
...
def ID3_chooseBestFeatureToSplit(dataset):
    ...
    for i in range(numFeatures): #遍历所有特征
        ...
        print("ID3 feature %d: It's infogain is：%.3f"%(i,infoGain))
...
def C45_chooseBestFeatureToSplit(dataset):
    ...
    for i in range(numFeatures): #遍历所有特征
        ...
        print("C4.5 feature %d: It's infogain is：%.3f"%(i,infoGain_ratio))
...
def CART_chooseBestFeatureToSplit(dataset):
    ...
    for i in range(numFeatures):
        ...
        print("CART feature %d: It's info gain is：%.3f"%(i,gini))
        if (gini < bestGini):
            bestGini = gini
            bestFeature = i
    return bestFeature
...
def ID3_createTree(dataset,labels):
    ...
    print("Best index is："+(bestFeatLabel))
...
if __name__ == '__main__':
    ...
    print("The following is the first time to find an optimal index:\n")
    print("The best feature index in ID3 algorithm: "+str(ID3_chooseBestFeatureToSplit(dataset)))
    print ("--------------------------------------------------")
    print("The best feature index in C45 algorithm: "+str(C45_chooseBestFeatureToSplit(dataset)))
    print ("--------------------------------------------------")
    print("The best feature index in CART algorithm: "+str(CART_chooseBestFeatureToSplit(dataset)))
    print("The first search for the optimal index ends")
    print("---------------------------------------------")

    print("Now let's create the corresponding decision tree-------")
    
    while(True):    
        dec_tree=str(input("Please choose decision tree:->(1:ID3; 2:C4.5; 3:CART)|('enter q to quit!')|："))
        #ID3决策树
        if dec_tree=='1':
            ...
            print("The following is test dataset result：")
